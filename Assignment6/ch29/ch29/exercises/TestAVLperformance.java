...
public class TestAVLperformance {
	...
	static TestAVLperformance AVLperform = new TestAVLperformance();
	
	public static void main(String[] args) {
		
		Random rnd = new Random();				
		AVLTree<Integer> tree = AVLperform.new AVLTree<Integer>();
		...
		ShuffleTree(tree);		
		System.out.println("Member search time for AVL Tree is " +
			      getTestTime(tree) + " milliseconds");		

		ShuffleTree(tree);
		System.out.println("Remove element time for AVL Tree is " +
			      getRemoveTime(tree) + " milliseconds\n");
		
	}
	
	public static long getTestTime(AVLTree<Integer> c) {
	  ...
	  public static long getRemoveTime(AVLTree<Integer> c) {
	    long startTime = System.currentTimeMillis();
	  ...
	  public static AVLTree<Integer> ShuffleTree(AVLTree<Integer> t) {
	  ...
	  public class AVLTree<E extends Comparable<E>> extends BST<E> {
		  ...
		  protected class AVLTreeNode<T extends Comparable<E>> extends TreeNode<E> {
	  ...
	  public class BST<T extends Comparable<T>> extends AbstractTree<T> {
			...
			public java.util.ArrayList<TreeNode<T>> path(T e) {
				java.util.ArrayList<TreeNode<T>> list = new java.util.ArrayList<TreeNode<T>>();
				TreeNode<T> current = root; // Start from the root
...
}//end of TestAVLperformance Class
